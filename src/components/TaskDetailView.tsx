...
import { Trash2, Maximize2, ArrowLeft, Send } from 'lucide-react';
         ...
         {task.notes.map((note) => (
          ...
          <div className="relative">
             <textarea
                ...
                className="w-full p-4 pr-12 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all"
